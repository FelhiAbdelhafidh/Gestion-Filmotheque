...
class FilmController extends Controller {
    ...
    public function indexAction(Request $request) {
        ...
        $filmslist = $em->getRepository('FilmBundle:Film')->findAll();
        //inserer pagination
        $films = $this->get('knp_paginator')->paginate(
                $filmslist, $request->query->get('page', 1)/* page number */, 3/* limit per page */
        );
...
//        $filmslist = $em->getRepository('FilmBundle:Film')->findBy(array('titre'=>$motCle));
        //inserer pagination
        $filmslist = $em->getRepository('FilmBundle:Film')->FindFilmByTitre($motCle);
